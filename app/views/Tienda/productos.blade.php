...
<head>
  ...
  display: none;
      ...
      <body class="body-gris" style="overflow-x: hidden;">
              ...
              <div class="row">
                <div class="col-xs-7">
                  <div class="input-group">
                    ...
                    <input id="cantidad" type="text" name="quant[1]" class="form-control input-number width-cel" value="1" min="1" max="50">
                    <span class="input-group-btn">
                      <button style="background-color: #A4BD31; color: white; "  type="button" class="btn btn-default btn-number move-more move-more2" data-type="plus" data-field="quant[1]">
